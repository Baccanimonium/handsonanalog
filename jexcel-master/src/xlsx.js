/* ATTENTION - THIS FILE HAS BEEN CHANGED / CUSTOMIZED - IF YOU NEED THE ORIGINAL FILE, PLEASE GO TO sheetjs.com */
...
function make_xlsx_lib (XLSX) {
  XLSX.version = '0.14.3'
  var current_codepage = 1200; var current_ansi = 1252
  ...
  var debom = function (data) {
    var c1 = data.charCodeAt(0); var c2 = data.charCodeAt(1)
  ...
  var Base64 = (function make_b64 () {
    ...
    return {
      encode: function (input) {
        var o = ''
        var c1 = 0; var c2 = 0; var c3 = 0; var e1 = 0; var e2 = 0; var e3 = 0; var e4 = 0
  ...
  var chr0 = /\u0000/g; var chr1 = /[\u0001-\u0006]/g
  /* ssf.js (C) 2013-present SheetJS -- http://sheetjs.com */
  /* jshint -W041 */
  var SSF = ({})
  var make_ssf = function make_ssf (SSF) {
    SSF.version = '0.10.2'
    function _strrev (x) { var o = ''; var i = x.length - 1; while (i >= 0) o += x.charAt(i--); return o }
    ...
    function frac (x, D, mixed) {
      var sgn = x < 0 ? -1 : 1
      var B = x * sgn
      var P_2 = 0; var P_1 = 1; var P = 0
      var Q_2 = 1; var Q_1 = 0; var Q = 0
      var A = Math.floor(B)
      while (Q_1 < D) {
        A = Math.floor(B)
        P = A * P_1 + P_2
    ...
    function parse_date_code (v, opts, b2) {
      ...
      var date = (v | 0); var time = Math.floor(86400 * (v - date)); var dow = 0
      var dout = []
      ...
      if (date === 60) { dout = b2 ? [1317, 10, 29] : [1900, 2, 29]; dow = 3 } else if (date === 0) { dout = b2 ? [1317, 8, 29] : [1900, 1, 0]; dow = 6 } else {
        if (date > 60) --date
    ...
    var general_fmt_num = (function make_general_fmt_num () {
      var gnr1 = /\.(\d*[1-9])0+$/; var gnr2 = /\.0*$/; var gnr4 = /\.(\d*[1-9])0+/; var gnr5 = /\.0*[Ee]/; var gnr6 = /(E[+-])(\d)$/
      function gfn2 (v) {
        var w = (v < 0 ? 12 : 11)
      ...
      return function general_fmt_num (v) {
        var V = Math.floor(Math.log(Math.abs(v)) * Math.LOG10E); var o
    ...
    function write_date (type, fmt, val, ss0) {
      var o = ''; var ss = 0; var tt = 0; var y = val.y; var out; var outl = 0
      switch (type) {
    ...
    function commaify (s) {
      ...
      var j = (s.length % w); var o = s.substr(0, j)
    ...
    var write_num = (function make_write_num () {
      ...
      function write_num_pct (type, fmt, val) {
        var sfmt = fmt.replace(pct1, ''); var mul = fmt.length - sfmt.length
      ...
      function write_num_f1 (r, aval, sign) {
        var den = parseInt(r[4], 10); var rr = Math.round(aval * den); var base = Math.floor(rr / den)
        var myn = (rr - base * den); var myd = den
      ...
      function write_num_flt (type, fmt, val) {
        ...
        var o
        var r; var ri; var ff; var aval = Math.abs(val); var sign = val < 0 ? '-' : ''
        ...
        if ((r = fmt.match(/^([#0?]+)\.([#0]+)$/))) {
          ...
          ri = o.indexOf('.')
          var lres = fmt.indexOf('.') - ri; var rres = fmt.length - o.length - lres
    ...
    function eval_fmt (fmt, v, opts, flen) {
      var out = []; var o = ''; var i = 0; var c = ''; var lst = 't'; var dt; var j; var cc
      var hr = 'H'
      /* Tokenize */
      while (i < fmt.length) {
        switch ((c = fmt.charAt(i))) {
          ...
          case '\\': var w = fmt.charAt(++i); var t = (w === '(' || w === ')') ? w : 't'
          ...
          case 'A': case 'a':
            ...
            if (fmt.substr(i, 3).toUpperCase() === 'A/P') { if (dt != null) q.v = dt.H >= 12 ? 'P' : 'A'; q.t = 'T'; hr = 'h'; i += 3 } else if (fmt.substr(i, 5).toUpperCase() === 'AM/PM') { if (dt != null) q.v = dt.H >= 12 ? 'PM' : 'AM'; q.t = 'T'; i += 5; hr = 'h' } else { q.t = 't'; ++i }
      ...
      if (nstr.length > 0) {
        ...
        if (decpt === out.length && ostr.indexOf('E') === -1) {
          for (i = out.length - 1; i >= 0; --i) {
            ...
            if (jj >= out[i].v.length - 1) { jj -= out[i].v.length; out[i].v = ostr.substr(jj + 1, out[i].v.length) } else if (jj < 0) out[i].v = ''
    ...
    function choose_fmt (f, v) {
      var fmt = split_fmt(f)
      var l = fmt.length; var lat = fmt[l - 1].indexOf('@')
      if (l < 4 && lat > -1) --l
  ...
  function dateNF_fix (str, dateNF, match) {
    var Y = -1; var m = -1; var d = -1; var H = -1; var M = -1; var S = -1;
  ...
  (function (factory) {
    ...
    function signed_crc_table () {
      var c = 0; var table = new Array(256)
    ...
    function crc32_bstr (bstr, seed) {
      var C = seed ^ -1; var L = bstr.length - 1
      for (var i = 0; i < L;) {
    ...
    function crc32_buf (buf, seed) {
      ...
      var C = seed ^ -1; var L = buf.length - 3
      for (var i = 0; i < L;) {
    ...
    function crc32_buf_8 (buf, seed) {
      var C = seed ^ -1; var L = buf.length - 7
      for (var i = 0; i < L;) {
        C = (C >>> 8) ^ T[(C ^ buf[i++]) & 0xFF]
        C = (C >>> 8) ^ T[(C ^ buf[i++]) & 0xFF]
        C = (C >>> 8) ^ T[(C ^ buf[i++]) & 0xFF]
...
*/
    ...
    function parse_extra_field (blob) {
      ...
      while (blob.l <= blob.length - 4) {
        ...
        var sz = blob.read_shift(2); var tgt = blob.l + sz
        var p = {}
        switch (type) {
    ...
    function parse (file, options) {
      ...
      var files = {}; var Paths = []; var FileIndex = []; var FullPaths = []
    ...
    function build_full_paths (FI, FP, Paths) {
      var i = 0; var L = 0; var R = 0; var C = 0; var j = 0; var pl = Paths.length
      var dad = []; var q = []
    ...
    function get_mfat_entry (entry, payload, mini) {
      var start = entry.start; var size = entry.size
    ...
    function sleuth_fat (idx, cnt, sectors, ssz, fat_addrs) {
      ...
      if (idx === ENDOFCHAIN) {
        ...
        var sector = sectors[idx]; var m = (ssz >>> 2) - 1
        if (!sector) return
        for (var i = 0; i < m; ++i) {
    ...
    function get_sector_list (sectors, start, fat_addrs, ssz, chkd) {
      var buf = []; var buf_chain = []
      if (!chkd) chkd = []
      var modulus = ssz - 1; var j = 0; var jj = 0
      for (j = start; j >= 0;) {
        chkd[j] = true
        buf[buf.length] = j
    ...
    function make_sector_list (sectors, dir_start, fat_addrs, ssz) {
      var sl = sectors.length; var sector_list = ([])
      var chkd = []; var buf = []; var buf_chain = []
      var modulus = ssz - 1; var i = 0; var j = 0; var k = 0; var jj = 0
      for (i = 0; i < sl; ++i) {
        buf = ([])
    ...
    function read_directory (dir_start, sector_list, sectors, Paths, nmfs, files, FileIndex, mini) {
      var minifat_store = 0; var pl = (Paths.length ? 2 : 0)
      var sector = sector_list[dir_start].data
      var i = 0; var namelen = 0; var name
    ...
    function init_cfb (cfb, opts) {
      var o = opts || {}; var root = o.root || 'Root Entry'
    ...
    function rebuild_cfb (cfb, f) {
      ...
      var now = new Date(1987, 1, 19); var j = 0
      var data = []
    ...
    function _write (cfb, options) {
      ...
      var L = (function (cfb) {
        var mini_size = 0; var fat_size = 0
    ...
    function find (cfb, path) {
      ...
      var k = false
      if (path.charCodeAt(0) === 47 /* "/" */) { k = true; path = UCFullPaths[0].slice(0, -1) + path } else k = path.indexOf('/') !== -1
    ...
    function read_bits_2 (buf, bl) { var w = (bl & 7); var h = (bl >>> 3); return ((buf[h] | (w <= 6 ? 0 : buf[h + 1] << 8)) >>> w) & 0x03 }
    function read_bits_3 (buf, bl) { var w = (bl & 7); var h = (bl >>> 3); return ((buf[h] | (w <= 5 ? 0 : buf[h + 1] << 8)) >>> w) & 0x07 }
    function read_bits_4 (buf, bl) { var w = (bl & 7); var h = (bl >>> 3); return ((buf[h] | (w <= 4 ? 0 : buf[h + 1] << 8)) >>> w) & 0x0F }
    function read_bits_5 (buf, bl) { var w = (bl & 7); var h = (bl >>> 3); return ((buf[h] | (w <= 3 ? 0 : buf[h + 1] << 8)) >>> w) & 0x1F }
    function read_bits_7 (buf, bl) { var w = (bl & 7); var h = (bl >>> 3); return ((buf[h] | (w <= 1 ? 0 : buf[h + 1] << 8)) >>> w) & 0x7F }

    /* works up to n = 3 * 8 + 1 = 25 */
    function read_bits_n (buf, bl, n) {
      var w = (bl & 7); var h = (bl >>> 3); var f = ((1 << n) - 1)
      var v = buf[h] >>> w
      if (n < 8 - w) return v & f
      v |= buf[h + 1] << (8 - w)
    ...
    function realloc (b, sz) {
      var L = b.length; var M = 2 * L > sz ? 2 * L : sz + 5; var i = 0
      if (L >= sz) return b
      if (has_buf) {
    ...
    function build_tree (clens, cmap, MAX) {
      var maxlen = 1; var w = 0; var i = 0; var j = 0; var ccode = 0; var L = clens.length
    ...
    var dyn_len_1 = 1; var dyn_len_2 = 1
    ...
    function dyn (data, boff) {
      ...
      var h1 = hcodes.slice(0, _HLIT); var h2 = hcodes.slice(_HLIT)
    ...
    function inflate (data, usz) {
      ...
      var outbuf = new_unsafe_buf(usz || (1 << 18))
      var woff = 0
      var OL = outbuf.length >>> 0
      var max_len_1 = 0; var max_len_2 = 0
    ...
    function write_zip (cfb, options) {
      ...
      var out = []; var cdirs = []
      var o = new_buf(1)
      var method = (_opts.compression ? 8 : 0); var flags = 0
      var desc = false
      if (desc) flags |= 8
      var i = 0; var j = 0

      var start_cd = 0; var fcnt = 0
      var root = cfb.FullPaths[0]; var fp = root; var fi = cfb.FileIndex[0]
      var crcs = []
      var sz_cd = 0
  ...
  function parse_isodur (s) {
    var sec = 0; var mt = 0; var time = false
  ...
  function fuzzydate (s) {
    var o = new Date(s); var n = new Date(NaN)
    var y = o.getYear(); var m = o.getMonth(); var d = o.getDate()
    if (isNaN(d)) return n
  ...
  function safegetzipfile (zip, file) {
    ...
    var f = file.toLowerCase(); var g = f.replace(/\//g, '\\')
    for (var i = 0; i < k.length; ++i) {
  ...
  function parsexmltag (tag, skip_root) {
    ...
    var m = tag.match(attregexg); var j = 0; var v = ''; var i = 0; var q = ''; var cc = ''; var quot = 1
    if (m) {
  ...
  var unescapexml = (function () {
    ...
    var encregex = /&(?:quot|apos|gt|lt|amp|#x?([\da-fA-F]+));/g; var coderegex = /_x([\da-fA-F]{4})_/g
    return function unescapexml (text) {
      var s = text + ''; var i = s.indexOf('<![CDATA[')
  ...
  var utf8read = function utf8reada (orig) {
    var out = ''; var i = 0; var c = 0; var d = 0; var e = 0; var f = 0; var w = 0
    while (i < orig.length) {
      c = orig.charCodeAt(i++)
  ...
  var utf8write = function (orig) {
    var out = []; var i = 0; var c = 0; var d = 0
    while (i < orig.length) {
      c = orig.charCodeAt(i++)
      switch (true) {
  ...
  if (has_buf) {
    var utf8readb = function utf8readb (data) {
      var out = Buffer.alloc(2 * data.length); var w; var i; var j = 1; var k = 0; var ww = 0; var c
      for (i = 0; i < data.length; i += j) {
        j = 1
        if ((c = data.charCodeAt(i)) < 128) w = c
        else if (c < 224) { w = (c & 31) * 64 + (data.charCodeAt(i + 1) & 63); j = 2 } else if (c < 240) { w = (c & 15) * 4096 + (data.charCodeAt(i + 1) & 63) * 64 + (data.charCodeAt(i + 2) & 63); j = 3 } else {
          j = 4
  ...
  var vtvregex = /<\/?(?:vt:)?variant>/g; var vtmregex = /<(?:vt:)([^>]*)>([\s\S]*)</
  ...
  function write_double_le (b, v, idx) {
    var bs = ((((v < 0) || (1 / v == -Infinity)) ? 1 : 0) << 7); var e = 0; var m = 0
    var av = bs ? (-v) : v
    if (!isFinite(av)) { e = 0x7ff; m = isNaN(v) ? 0x6969 : 0 } else if (av == 0) e = m = 0
    else {
      e = Math.floor(Math.log(av) / Math.LN2)
      m = av * Math.pow(2, 52 - e)
      if ((e <= -1023) && (!isFinite(m) || (m < Math.pow(2, 52)))) { e = -1022 } else { m -= Math.pow(2, 52); e += 1023 }
    }
  ...
  var __toBuffer = function (bufs) { var x = []; var w = 10240; for (var i = 0; i < bufs[0].length; ++i) if (bufs[0][i]) for (var j = 0, L = bufs[0][i].length; j < L; j += w) x.push.apply(x, bufs[0][i].slice(j, j + w)); return x }
  ...
  function ReadShift (size, t) {
    var o = ''; var oI; var oR; var oo = []; var w; var vv; var i; var loc
    switch (t) {
      case 'dbcs':
        loc = this.l
      ...
      default:
        switch (size) {
          ...
          case 4: case -4:
            if (t === 'i' || ((this[this.l + 3] & 0x80) === 0)) { oI = ((size > 0) ? __readInt32LE : __readInt32BE)(this, this.l); this.l += 4; return oI } else { oR = __readUInt32LE(this, this.l); this.l += 4 } return oR
          case 8: case -8:
            if (t === 'f') {
  ...
  function recordhopper (data, cb, opts) {
    ...
    var L = data.length; var RT = 0; var tgt = 0
    while (data.l < L) {
  ...
  function buf_array () {
    var bufs = []; var blksz = has_buf ? 256 : 2048
  ...
  function write_record (ba, type, payload, length) {
    ...
    for (var i = 0; i != 4; ++i) {
      if (length >= 0x80) { o.write_shift(1, (length & 0x7F) + 0x80); length >>= 7 } else { o.write_shift(1, length); break }
    }
  ...
  var make_offcrypto = function (O, _crypto) {
    ...
    O.rc4 = function (key, data) {
      var S = new Array(256)
      var c = 0; var i = 0; var j = 0; var t = 0
  ...
  function decode_col (colstr) { var c = unfix_col(colstr); var d = 0; var i = 0; for (; i !== c.length; ++i) d = 26 * d + c.charCodeAt(i) - 64; return d - 1 }
    ...
    for (var R = 0; R != data.length; ++R) {
      ...
      for (var C = 0; C != data[R].length; ++C) {
        ...
        if (data[R][C] && typeof data[R][C] === 'object' && !Array.isArray(data[R][C]) && !(data[R][C] instanceof Date)) cell = data[R][C]
          ...
          if (cell.v === null) { if (cell.f) cell.t = 'n'; else if (!o.sheetStubs) continue; else cell.t = 'z' } else if (typeof cell.v === 'number') cell.t = 'n'
          else if (typeof cell.v === 'boolean') cell.t = 'b'
          else if (cell.v instanceof Date) {
            cell.z = o.dateNF || SSF._table[14]
            if (o.cellDates) { cell.t = 'd'; cell.w = SSF.format(cell.z, datenum(cell.v)) } else { cell.t = 'n'; cell.v = datenum(cell.v); cell.w = SSF.format(cell.z, cell.v) }
          } else cell.t = 's'
        }
        if (dense) {
          if (!ws[__R]) ws[__R] = []
  ...
  function parse_RkNumber (data) {
    ...
    var fX100 = (b[0] & 1); var fInt = (b[0] & 2)
    data.l += 4
    b[0] &= 0xFC // b[0] &= ~3;
  ...
  function write_RkNumber (data, o) {
    ...
    var fX100 = 0; var fInt = 0; var d100 = data * 100
    if ((data == (data | 0)) && (data >= -(1 << 29)) && (data < (1 << 29))) { fInt = 1 } else if ((d100 == (d100 | 0)) && (d100 >= -(1 << 29)) && (d100 < (1 << 29))) { fInt = 1; fX100 = 1 }
  ...
  function parse_core_props (data) {
    ...
    for (var i = 0; i < CORE_PROPS.length; ++i) {
      var f = CORE_PROPS[i]; var cur = data.match(CORE_PROPS_REGEX[i])
  ...
  function write_core_props (cp, _opts) {
    var opts = _opts || {}
    var o = [XML_HEADER, CORE_PROPS_XML_ROOT]; var p = {}
      ...
      for (var i = 0; i != m.length; ++i) {
        ...
        switch (y[0]) {
          ...
          default: if (x.indexOf('<vt:') === 0) {
            var toks = x.split('>')
            var type = toks[0].slice(4); var text = toks[1]
  ...
  function xlml_write_custprops (Props, Custprops) {
    ...
    if (Props) {
      keys(Props).forEach(function (k) {
        ...
        var m = Props[k]
        var t = 'string'
        if (typeof m === 'number') { t = 'float'; m = String(m) } else if (m === true || m === false) { t = 'boolean'; m = m ? '1' : '0' } else m = String(m)
    ...
    if (Custprops) {
      keys(Custprops).forEach(function (k) {
        ...
        var m = Custprops[k]
        var t = 'string'
        if (typeof m === 'number') { t = 'float'; m = String(m) } else if (m === true || m === false) { t = 'boolean'; m = m ? '1' : '0' } else if (m instanceof Date) { t = 'dateTime.tz'; m = m.toISOString() } else m = String(m)
        o.push(writextag(escapexmltag(k), m, { 'dt:dt': t }))
      })
    }
  ...
  function parse_FILETIME (blob) {
    var dwLowDateTime = blob.read_shift(4); var dwHighDateTime = blob.read_shift(4)
    return new Date(((dwHighDateTime / 1e7 * Math.pow(2, 32) + dwLowDateTime / 1e7) - 11644473600) * 1000).toISOString().replace(/\.000/, '')
  }
  function write_FILETIME (time) {
    var date = (typeof time === 'string') ? new Date(Date.parse(time)) : time
    var t = date.getTime() / 1000 + 11644473600
    var l = t % Math.pow(2, 32); var h = (t - l) / Math.pow(2, 32)
    l *= 1e7; h *= 1e7
  ...
  function parse_TypedPropertyValue (blob, type, _opts) {
    var t = blob.read_shift(2); var ret; var opts = _opts || {}
    blob.l += 2
  ...
  function write_TypedPropertyValue (type, value) {
    var o = new_buf(4); var p = new_buf(4)
  ...
  function write_PropertySet (entries, RE, PIDSI) {
    var hdr = new_buf(8); var piao = []; var prop = []
    var sz = 8; var i = 0

    var pr = new_buf(8); var pio = new_buf(8)
  ...
  function parse_PropertySetStream (file, PIDSI, clsid) {
    ...
    var NumSets; var FMTID0; var FMTID1; var Offset0; var Offset1 = 0
  ...
  function parslurp (blob, length, cb) {
    var arr = []; var target = blob.l + length
  ...
  function parse_Bes (blob) {
    var v = blob.read_shift(1); var t = blob.read_shift(1)
  ...
  function parse_XLUnicodeRichExtendedString (blob) {
    ...
    var cch = blob.read_shift(2); var flags = blob.read_shift(1)
    var /* fHighByte = flags & 0x1, */ fExtSt = flags & 0x4; var fRichSt = flags & 0x8
    var width = 1 + (flags & 0x1) // 0x0 -> utf8, 0x1 -> dbcs
    var cRun = 0; var cbExtRst
    var z = {}
  ...
  function parse_URLMoniker (blob) {
    var len = blob.read_shift(4); var start = blob.l
    var extra = false
    if (len > 24) {
      /* look ahead */
      blob.l += len - 24
  ...
  function parse_Hyperlink (blob, length) {
    ...
    var flags = blob.read_shift(2)
    blob.l += 2
    var displayName; var targetFrameName; var moniker; var oleMoniker; var Loc = ''; var guid; var fileTime
  ...
  /* 2.5.178 LongRGBA */
  function parse_LongRGBA (blob) { var r = blob.read_shift(1); var g = blob.read_shift(1); var b = blob.read_shift(1); var a = blob.read_shift(1); return [r, g, b, a] }
  ...
  function parse_XTI (blob, length, opts) {
    ...
    var iSupBook = blob.read_shift(w); var itabFirst = blob.read_shift(w, 'i'); var itabLast = blob.read_shift(w, 'i')
  ...
  function parse_Window1 (blob) {
    var xWn = blob.read_shift(2); var yWn = blob.read_shift(2); var dxWn = blob.read_shift(2); var dyWn = blob.read_shift(2)
    var flags = blob.read_shift(2); var iTabCur = blob.read_shift(2); var iTabFirst = blob.read_shift(2)
    var ctabSel = blob.read_shift(2); var wTabRatio = blob.read_shift(2)
    return { Pos: [xWn, yWn],
      Dim: [dxWn, dyWn],
      Flags: flags,
      CurTab: iTabCur,
  ...
  function write_Font (data, opts) {
    ...
    var b5 = (opts && (opts.biff == 5)); var w = (b5 ? (15 + name.length) : (16 + 2 * name.length))
    var o = new_buf(w)
  ...
  function parse_Dimensions (blob, length, opts) {
    ...
    var r = blob.read_shift(w); var R = blob.read_shift(w)
    var c = blob.read_shift(2); var C = blob.read_shift(2)
    blob.l = end
  ...
  function parse_RK (blob) {
    var rw = blob.read_shift(2); var col = blob.read_shift(2)
  ...
  function parse_CellStyleXF (blob, length, style, opts) {
    var o = {}
    var a = blob.read_shift(4); var b = blob.read_shift(4)
    var c = blob.read_shift(4); var d = blob.read_shift(2)
  ...
  function parse_ExternSheet (blob, length, opts) {
    ...
    var o = []; var target = blob.l + length; var len = blob.read_shift(opts.biff > 8 ? 4 : 2)
  ...
  function parse_NoteSh (blob, length, opts) {
    ...
    var row = blob.read_shift(2); var col = blob.read_shift(2)
    var flags = blob.read_shift(2); var idObj = blob.read_shift(2)
  ...
  var DBF = (function () {
    ...
    function dbf_to_aoa (buf, opts) {
      ...
      var /* filedate = new Date(), */ nrow = 0; var fpos = 0
      ...
      if (l7) d.l += 36
      var fields = []; var field = ({})
      var hend = fpos - 10 - (vfp ? 264 : 0); var ww = l7 ? 32 : 11
    ...
    function sheet_to_dbf (ws, opts) {
      ...
      var headers = aoa[0]; var data = aoa.slice(1)
      var i = 0; var j = 0; var hcnt = 0; var rlen = 1
      for (i = 0; i < headers.length; ++i) {
        ...
        if (headers.indexOf(headers[i]) !== i) {
          for (j = 0; j < 1024; ++j) { if (headers.indexOf(headers[i] + '_' + j) == -1) { headers[i] += '_' + j; break } }
        }
      }
  ...
  var SYLK = (function () {
    ...
    function sylk_to_aoa_str (str, opts) {
      var records = str.split(/[\n\r]+/); var R = -1; var C = -1; var ri = 0; var rj = 0; var arr = []
      var formats = []
      var next_cell_format = null
      var sht = {}; var rowinfo = []; var colinfo = []; var cw = []
      var Mval = 0; var j
      for (; ri !== records.length; ++ri) {
        Mval = 0
        var rstr = records[ri].trim()
        var record = rstr.replace(/;;/g, '\u0001').split(';').map(function (x) { return x.replace(/\u0001/g, ';') })
        var RT = record[0]; var val
        if (rstr.length > 0) {
          switch (RT) {
            ...
            case 'P':
              ...
              break
            case 'C':
              var C_seen_K = false; var C_seen_X = false
              ...
              for (rj = 1; rj < record.length; ++rj) {
                switch (record[rj].charAt(0)) {
                  ...
                  case 'R': /* row properties */
                    ...
                    if (Mval > 0) { rowinfo[R].hpt = Mval; rowinfo[R].hpx = pt2px(Mval) } else if (Mval === 0) rowinfo[R].hidden = true
                    break
                  default: if (opts && opts.WTF) throw new Error('SYLK bad record ' + rstr)
                }
              }
    ...
    function sylk_to_sheet (d, opts) {
      ...
      var aoa = aoasht[0]; var ws = aoasht[1]
    ...
    function sheet_to_sylk (ws, opts) {
      var preamble = ['ID;PWXL;N;E']; var o = []
      var r = safe_decode_range(ws['!ref']); var cell
  ...
  var DIF = (function () {
    ...
    function dif_to_aoa_str (str, opts) {
      var records = str.split('\n'); var R = -1; var C = -1; var ri = 0; var arr = []
      for (; ri !== records.length; ++ri) {
        if (records[ri].trim() === 'BOT') { arr[++R] = []; C = 0; continue }
        if (R < 0) continue
        var metadata = records[ri].trim().split(',')
        var type = metadata[0]; var value = metadata[1]
        ++ri
        var data = records[ri].trim()
        switch (+type) {
          case -1:
            if (data === 'BOT') { arr[++R] = []; C = 0; continue } else if (data !== 'EOD') throw new Error('Unrecognized DIF special command ' + data)
            break
          case 0:
  ...
  var ETH = (function () {
    ...
    function eth_to_aoa (str, opts) {
      ...
      for (; ri !== records.length; ++ri) {
        ...
        switch (record[2]) {
          ...
          case 'vtc':
            switch (record[3]) {
              case 'nl': arr[R][C] = !!+record[4]; break
    ...
    function sheet_to_eth_data (ws) {
      if (!ws || !ws['!ref']) return ''
      var o = []; var oo = []; var cell; var coord = ''
      ...
      for (var R = r.s.r; R <= r.e.r; ++R) {
        for (var C = r.s.c; C <= r.e.c; ++C) {
          ...
          switch (cell.t) {
            ...
            case 'n':
              if (!cell.f) { oo[2] = 'v'; oo[3] = cell.v } else { oo[2] = 'vtf'; oo[3] = 'n'; oo[4] = cell.v; oo[5] = encode(cell.f) }
              break
            case 'b':
  ...
  var PRN = (function () {
    ...
    function guess_sep (str) {
      var cnt = {}; var instr = false; var end = 0; var cc = 0
    ...
    function dsv_to_sheet_str (str, opts) {
      ...
      if (str.slice(0, 4) == 'sep=' && str.charCodeAt(5) == 10) { sep = str.charAt(4); str = str.slice(6) } else sep = guess_sep(str.slice(0, 1024))
      var R = 0; var C = 0; var v = 0
      var start = 0; var end = 0; var sepcc = sep.charCodeAt(0); var instr = false; var cc = 0
      str = str.replace(/\r\n/mg, '\n')
      ...
      function finish_cell () {
        ...
        else if (o.raw) { cell.t = 's'; cell.v = s } else if (s.trim().length === 0) { cell.t = 's'; cell.v = s } else if (s.charCodeAt(0) == 0x3D) {
          if (s.charCodeAt(1) == 0x22 && s.charCodeAt(s.length - 1) == 0x22) { cell.t = 's'; cell.v = s.slice(2, -1).replace(/""/g, '"') } else if (fuzzyfmla(s)) { cell.t = 'n'; cell.f = s.slice(1) } else { cell.t = 's'; cell.v = s }
        } else if (s == 'TRUE') { cell.t = 'b'; cell.v = true } else if (s == 'FALSE') { cell.t = 'b'; cell.v = false } else if (!isNaN(v = fuzzynum(s))) { cell.t = 'n'; if (o.cellText !== false) cell.w = s; cell.v = v } else if (!isNaN(fuzzydate(s).getDate()) || _re && s.match(_re)) {
          cell.z = o.dateNF || SSF._table[14]
          var k = 0
          if (_re && s.match(_re)) { s = dateNF_fix(s, o.dateNF, (s.match(_re) || [])); k = 1 }
          if (o.cellDates) { cell.t = 'd'; cell.v = parseDate(s, k) } else { cell.t = 'n'; cell.v = datenum(parseDate(s, k)) }
        ...
        if (cell.t == 'z') {} else if (o.dense) { if (!ws[R]) ws[R] = []; ws[R][C] = cell } else ws[encode_cell({ c: C, r: R })] = cell
        start = end + 1
    ...
    function prn_to_sheet (d, opts) {
      var str = ''; var bytes = opts.type == 'string' ? [0, 0, 0, 0] : firstbyte(d, opts)
      switch (opts.type) {
  ...
  function read_wb_ID (d, opts) {
    var o = opts || {}; var OLD_WTF = !!o.WTF; o.WTF = true
    try {
  ...
  var WK_ = (function () {
    ...
    function lotus_to_workbook_buf (d, opts) {
      ...
      var o = opts || {}
      if (DENSE != null && o.dense == null) o.dense = DENSE
      var s = ((o.dense ? [] : {})); var n = 'Sheet1'; var sidx = 0
      var sheets = {}; var snames = [n]
      ...
      else if (d[2] == 0x0e) { o.Enum = WK3Enum; o.qpro = true; d.l = 0 } else throw new Error('Unrecognized LOTUS BOF ' + d[2])
  ...
  var parse_rs = (function parse_rs_factory () {
    var tregex = matchtag('t'); var rpregex = matchtag('rPr'); var rregex = /<(?:\w+:)?r>/g; var rend = /<\/(?:\w+:)?r>/; var nlregex = /\r\n/g
    /* 18.4.7 rPr CT_RPrElt */
    var parse_rpr = function parse_rpr (rpr, intro, outro) {
      var font = {}; var cp = 65001; var align = ''
      var pass = false
      var m = rpr.match(tagregex); var i = 0
      if (m) {
        for (;i != m.length; ++i) {
  ...
  /* 18.4.8 si CT_Rst */
  var sitregex = /<(?:\w+:)?t[^>]*>([^<]*)<\/(?:\w+:)?t>/g; var sirregex = /<(?:\w+:)?r>/
  ...
  function crypto_CreatePasswordVerifier_Method1 (Password) {
    var Verifier = 0x0000; var PasswordArray
    var PasswordDecoded = _JS2ANSI(Password)
    var len = PasswordDecoded.length + 1; var i; var PasswordByte
  ...
  var crypto_MakeXorDecryptor = function (password) {
    var XorArrayIndex = 0; var XorArray = crypto_CreateXorArray_Method1(password)
    return function (Data) {
  ...
  function rgb2HSL (rgb) {
    ...
    var M = Math.max(R, G, B); var m = Math.min(R, G, B); var C = M - m
    if (C === 0) return [0, 0, R]

    var H6 = 0; var S = 0; var L2 = (M + m)
    S = C / (L2 > 1 ? 2 - L2 : L2)
    switch (M) {
  ...
  function hsl2RGB (hsl) {
    ...
    var C = S * 2 * (L < 0.5 ? L : 1 - L); var m = L - C / 2
    var rgb = [m, m, m]; var h6 = 6 * H
  ...
  var DEF_MDW = 6; var MAX_MDW = 15; var MIN_MDW = 1; var MDW = DEF_MDW
  ...
  function find_mdw_colw (collw) {
    var delta = Math.abs(collw - cycle_width(collw)); var _MDW = MDW
  ...
  var DEF_PPI = 96; var PPI = DEF_PPI
  ...
  function parse_numFmts (t, styles, opts) {
    ...
    for (i = 0; i < m.length; ++i) {
      ...
      switch (strip_ns(y[0])) {
        ...
        case '<numFmt': {
          var f = unescapexml(utf8read(y.formatCode)); var j = parseInt(y.numFmtId, 10)
  ...
  function write_sty_xml (wb, opts) {
    var o = [XML_HEADER, STYLES_XML_ROOT]; var w
  ...
  var rc_to_a1 = (function () {
    ...
    function rcfunc ($$, $1, $2, $3, $4, $5) {
      var R = $3.length > 0 ? parseInt($3, 10) | 0 : 0; var C = $5.length > 0 ? parseInt($5, 10) | 0 : 0
      if (C < 0 && $4.length === 0) C = 0
      var cRel = false; var rRel = false
  ...
  function shift_formula_xlsx (f, range, cell) {
    var r = decode_range(range); var s = r.s; var c = decode_cell(cell)
  ...
  function parse_RgceArea_BIFF2 (blob) {
    var r = parse_ColRelU(blob, 2); var R = parse_ColRelU(blob, 2)
  ...
  function parse_RgceAreaRel (blob, length, opts) {
    ...
    var r = blob.read_shift(opts.biff == 12 ? 4 : 2); var R = blob.read_shift(opts.biff == 12 ? 4 : 2)
    var c = parse_ColRelU(blob, 2)
    var C = parse_ColRelU(blob, 2)
    return { s: { r: r, c: c[0], cRel: c[1], rRel: c[2] }, e: { r: R, c: C[0], cRel: C[1], rRel: C[2] } }
  }
  ...
  function parse_RgceLocRel (blob, length, opts) {
    ...
    var cRel = (cl & 0x4000) >> 14; var rRel = (cl & 0x8000) >> 15
    cl &= 0x3FFF
  ...
  function parse_RgceLocRel_BIFF2 (blob) {
    ...
    var c = blob.read_shift(1)
    var rRel = (rl & 0x8000) >> 15; var cRel = (rl & 0x4000) >> 14
    rl &= 0x3FFF
  ...
  function parse_PtgAttrSpaceType (blob) {
    var type = blob.read_shift(1); var cch = blob.read_shift(1)
    return [type, cch]
  }
  ...
  function parse_PtgFuncVar (blob, length, opts) {
    ...
    var cparams = blob.read_shift(1); var tab = opts && opts.biff <= 3 ? [(type == 0x58 ? -1 : 0), blob.read_shift(1)] : parsetab(blob)
  ...
  function parse_Rgce (blob, length, opts) {
    var target = blob.l + length
    var R; var id; var ptgs = []
    while (target != blob.l) {
      length = target - blob.l
      id = blob[blob.l]
      R = PtgTypes[id]
      if (id === 0x18 || id === 0x19) R = (id === 0x18 ? Ptg18 : Ptg19)[blob[blob.l + 1]]
      if (!R || !R.f) { /* ptgs.push */(parsenoop(blob, length)) } else { ptgs.push([R.n, R.f(blob, length, opts)]) }
    }
    return ptgs
  }
  ...
  function stringify_formula (formula/* Array<any> */, range, cell, supbooks, opts) {
    ...
    var stack = []; var e1; var e2; var c; var ixti = 0; var nameidx = 0; var r; var sname = ''
    if (!formula[0] || !formula[0][0]) return ''
    var last_sp = -1; var sp = ''
  ...
  function parse_ArrayParsedFormula (blob, length, opts) {
    var target = blob.l + length; var len = opts.biff == 2 ? 1 : 2
    var rgcb; var cce = blob.read_shift(len) // length of rgce
  ...
  function parse_SharedParsedFormula (blob, length, opts) {
    var target = blob.l + length
    var rgcb; var cce = blob.read_shift(2) // length of rgce
    var rgce = parse_Rgce(blob, cce, opts)
    if (cce == 0xFFFF) return [[], parsenoop(blob, length - 2)]
  ...
  function col_obj_w (C, col) {
    ...
    if (wch > -1) { p.width = char2width(wch); p.customWidth = 1 } else if (col.width != null) p.width = col.width
  ...
  function get_cell_style (styles, cell, opts) {
    ...
    var i = 0x3c; var len = styles.length
    if (z == null && opts.ssf) {
      for (; i < 0x188; ++i) {
        if (opts.ssf[i] == null) {
          SSF.load(cell.z, i)
  ...
  function parse_ws_xml (data, opts, idx, rels, wb, themes, styles) {
    ...
    if (_merge) {
      for (ridx = 0; ridx != _merge.length; ++ridx) { merges[ridx] = safe_decode_range(_merge[ridx].slice(_merge[ridx].indexOf('"') + 1)) }
    }
  ...
  function parse_ws_xml_cols (columns, cols) {
    ...
    for (var coli = 0; coli != cols.length; ++coli) {
      ...
      var colm = parseInt(coll.min, 10) - 1; var colM = parseInt(coll.max, 10) - 1
  ...
  function write_ws_xml_cell (cell, ref, ws, opts) {
    ...
    var vv = ''
    var oldt = cell.t; var oldv = cell.v
    switch (cell.t) {
    ...
    var v = writetag('v', escapexml(vv)); var o = ({ r: ref })
    /* TODO: cell style */
  ...
  var parse_ws_xml_data = (function () {
    var cellregex = /<(?:\w+:)?c[ >]/; var rowregex = /<\/(?:\w+:)?row>/
    var rregex = /r=["']([^"']*)["']/; var isregex = /<(?:\w+:)?is>([\S\s]*?)<\/(?:\w+:)?is>/
    var refregex = /ref=["']([^"']*)["']/
    var match_v = matchtag('v'); var match_f = matchtag('f')

    return function parse_ws_xml_data (sdata, s, opts, guess, themes, styles) {
      var ri = 0; var x = ''; var cells = []; var cref = []; var idx = 0; var i = 0; var cc = 0; var d = ''; var p
      var tag; var tagr = 0; var tagc = 0
      var sstr, ftag
      var fmtid = 0; var fillid = 0
      var do_format = Array.isArray(styles.CellXf); var cf
      var arrayf = []
      var sharedf = []
      var dense = Array.isArray(s)
      var rows = []; var rowobj = {}; var rowrite = false
      for (var marr = sdata.split(rowregex), mt = 0, marrlen = marr.length; mt != marrlen; ++mt) {
        ...
        for (ri = 0; ri != cells.length; ++ri) {
          ...
          // CUSTOM MODIFICATION TO PARSE STYLE TO CSS
          if (tag.s && styles.CellXf[tag.s]) {
			    var styleData = styles.CellXf[tag.s]
			    // p.s = tag.s;
			    p.style = []
			    // Align
			    if (styles.CellXf[tag.s].applyAlignment) {
			        if (styles.CellXf[tag.s].alignment && styles.CellXf[tag.s].alignment.horizontal && styles.CellXf[tag.s].alignment.horizontal != 'general') {
			            p.style.push('text-align:' + styles.CellXf[tag.s].alignment.horizontal)
			        }
			        if (styles.CellXf[tag.s].alignment && styles.CellXf[tag.s].alignment.wrapText) {
			            p.style.push('white-space:pre-wrap')
			        }
			    }
            // Border
			    if (styles.CellXf[tag.s].applyBorder) {
            }
            // Background color
			    if (styles.Fills[styles.CellXf[tag.s].fillId] && styles.Fills[styles.CellXf[tag.s].fillId].fgColor) {
			        var theme = styles.Fills[styles.CellXf[tag.s].fillId].fgColor.theme
			        if (styles.Fills[styles.CellXf[tag.s].fillId].fgColor.rgb) {
                var rgb = styles.Fills[styles.CellXf[tag.s].fillId].fgColor.rgb
			        } else if (themes.themeElements.clrScheme[theme] && themes.themeElements.clrScheme[theme].rgb) {
			            var rgb = themes.themeElements.clrScheme[theme].rgb
			        }

			        if (rgb) {
			            p.style.push('background-color:#' + rgb)
			        }
            }

			    // if (tag.r == 'A4' || tag.r == 'B4') {
			      //  console.log(tag, styles.Fills[styles.CellXf[tag.s].fillId].fgColor);
			    // }
            // Font style
            if (styles.CellXf[tag.s].applyFont) {
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].color && styles.Fonts[styles.CellXf[tag.s].fontId].color.rgb) {
                // p.style.push('color:#' + styles.Fonts[styles.CellXf[tag.s].fontId].color.rgb);
              }
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].bold) {
                p.style.push('text-weight:bold')
              }
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].italic) {
                p.style.push('font-style: italic')
              }
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].name) {
                // p.style.push('font-family:' + styles.Fonts[styles.CellXf[tag.s].fontId].name);
              }
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].sz) {
                // p.style.push('font-size:' + styles.Fonts[styles.CellXf[tag.s].fontId].sz);
              }
              if (styles.Fonts[styles.CellXf[tag.s].fontId] && styles.Fonts[styles.CellXf[tag.s].fontId].underline) {
                p.style.push('text-decoration:underline')
              }
            }
            // Number format
            if (styles.CellXf[tag.s].applyNumberFormat) {
            }

            // Style
            if (p.style.length) {
              p.style = p.style.join(';')
            } else {
              delete (p.style)
            }
          }
          ...
          if (tag.t == null && p.v === undefined) {
            if (p.f || p.F) {
              p.v = 0; p.t = 'n'
            } else if (!opts.sheetStubs && !p.style) continue
            else p.t = 'z'
          } else p.t = tag.t || 'n'
  ...
  function write_ws_xml_data (ws, opts, idx, wb) {
    var o = []; var r = []; var range = safe_decode_range(ws['!ref']); var cell = ''; var ref; var rr = ''; var cols = []; var R = 0; var C = 0; var rows = ws['!rows']
    var dense = Array.isArray(ws)
    var params = ({ r: rr }); var row; var height = -1
  ...
  function write_ws_xml (idx, opts, wb, rels) {
    ...
    var s = wb.SheetNames[idx]; var sidx = 0; var rdata = ''
    var ws = wb.Sheets[s]
    if (ws == null) ws = {}
    var ref = ws['!ref'] || 'A1'
      ...
      switch (RT) {
        ...
        case 0x000B: /* 'BrtFmlaError' */
          ...
          switch (val[2]) {
            ...
            case 'b': p.v = !!val[1]; break
            case 'e': p.v = val[1]; if (opts.cellText !== false) p.w = BErr[p.v]; break
            case 'str': p.t = 's'; p.v = val[1]; break
          }
          if ((cf = styles.CellXf[val[0].iStyleRef])) safe_format(p, cf.numFmtId, null, opts, themes, styles)
          C = val[0].c
          if (opts.dense) { if (!s[R]) s[R] = []; s[R][C] = p } else s[encode_col(C) + rr] = p
          if (opts.cellFormula) {
            af = false
  ...
  function write_CELLTABLE (ba, ws, idx, opts) {
    var range = safe_decode_range(ws['!ref'] || 'A1'); var ref; var rr = ''; var cols = []
  ...
  function write_ws_bin (idx, opts, wb, rels) {
    var ba = buf_array()
    var s = wb.SheetNames[idx]; var ws = wb.Sheets[s] || {}
  ...
  function parse_wb_xml (data, opts) {
    ...
    var pass = false; var xmlns = 'xmlns'
    var dname = {}; var dnstart = 0
  ...
  function parse_wb_bin (data, opts) {
    ...
    recordhopper(data, function hopper_wb (val, R_n, RT) {
      switch (RT) {
        ...
        default:
          if ((R_n || '').indexOf('Begin') > 0) { /* empty */ } else if ((R_n || '').indexOf('End') > 0) { /* empty */ } else if (!pass || (opts.WTF && state[state.length - 1] != 'BrtACBegin' && state[state.length - 1] != 'BrtFRTBegin')) throw new Error('Unexpected record ' + RT + ' ' + R_n)
      }
    }, opts)
  ...
  function write_BOOKVIEWS (ba, wb) {
    ...
    var i = 0; var vistab = -1; var hidden = -1
...
*/
  ...
  function xlml_parsexmltag (tag, skip_root) {
    ...
    var m = tag.match(attregexg2); var y; var j; var w; var i
    if (m) {
      for (i = 0; i != m.length; ++i) {
  ...
  function parse_xlml_data (xml, ss, data, cell, base, styles, csty, row, arrayf, o) {
    var nf = 'General'; var sid = cell.StyleID; var S = {}; o = o || {}
    var interiors = []
    var i = 0
  ...
  function parse_xlml_xml (d, _opts) {
    ...
    var opening = str.slice(0, 1024).toLowerCase(); var ishtml = false
    if (opening.indexOf('<?xml') == -1) ['html', 'table', 'head', 'meta', 'script', 'style', 'div'].forEach(function (tag) { if (opening.indexOf('<' + tag) >= 0) ishtml = true })
    if (ishtml) return HTML_.to_workbook(str, opts)
    var Rn
    var state = []; var tmp
    if (DENSE != null && opts.dense == null) opts.dense = DENSE
    var sheets = {}; var sheetnames = []; var cursheet = (opts.dense ? [] : {}); var sheetname = ''
    var table = {}; var cell = ({}); var row = {}// eslint-disable-line no-unused-vars
    var dtag = xlml_parsexmltag('<Data ss:Type="String">'); var didx = 0
    var c = 0; var r = 0
    var refguess = { s: { r: 2000000, c: 2000000 }, e: { r: 0, c: 0 } }
    var styles = {}; var stag = {}
    var ss = ''; var fidx = 0
    var merges = []
    var Props = {}; var Custprops = {}; var pidx = 0; var cp = []
    var comments = []; var comment = ({})
    var cstys = []; var csty; var seencol = false
    var arrayf = []
    var rowinfo = []; var rowobj = {}; var cc = 0; var rr = 0
    var Workbook = ({ Sheets: [], WBProps: { date1904: false } }); var wsprops = {}
      ...
      switch (Rn[3]) {
        ...
        case 'Cell':
          if (Rn[1] === '/') {
            ...
            if (!opts.sheetStubs) { if (cell.MergeAcross) c = cc + 1; else ++c } else if (cell.MergeAcross || cell.MergeDown) {
        ...
        /* FODS file root is <office:document> */
          ...
          /* OfficeDocumentSettings */
            ...
            case 'WorksheetOptions': switch (Rn[3]) {
              case 'Visible':
                if (Rn[0].slice(-2) === '/>') { /* empty */ } else if (Rn[1] === '/') {
  ...
  function write_ws_xlml_table (ws, opts, idx, wb) {
    ...
    for (var R = range.s.r; R <= range.e.r; ++R) {
      ...
      for (var C = range.s.c; C <= range.e.c; ++C) {
        ...
        if (skip) continue
        var addr = { r: R, c: C }
        var ref = encode_cell(addr); var cell = dense ? (ws[R] || [])[C] : ws[ref]
...
*/
  ...
  function parse_workbook (blob, options) {
    ...
    var cur_sheet = ''
    var Preamble = {}
    var lastcell; var last_cell = ''; var cc; var cmnt; var rngC; var rngR
    var sharedf = {}
    var arrayf = []
    var temp_val
    var country
    ...
    var XFs = [] /* XF records */
    var palette = []
    var Workbook = ({ Sheets: [], WBProps: { date1904: false }, Views: [{}] }); var wsprops = {}
    ...
    var colinfo = []; var rowinfo = []
    // eslint-disable-next-line no-unused-vars
    var defwidth = 0; var defheight = 0 // twips / MDW respectively
    var seencol = false
    ...
    var BIFF2Fmt = 0; var BIFF2FmtTable = []
          ...
          case 'Formula': {
            ...
            if (options.cellFormula) {
              ...
              if (_f && _f[0] && _f[0][0] && _f[0][0][0] == 'PtgExp') {
                var _fr = _f[0][0][1][0]; var _fc = _f[0][0][1][1]
  ...
  function write_xls_props (wb, cfb) {
    var DSEntries = []; var SEntries = []; var CEntries = []
    var i = 0; var Keys
    if (wb.Props) {
      Keys = keys(wb.Props)
      // $FlowIgnore
  ...
  function write_BIFF2BERR (r, c, val, t) {
    var out = new_buf(9)
    write_BIFF2Cell(out, r, c)
    if (t == 'e') { out.write_shift(1, val); out.write_shift(1, 1) } else { out.write_shift(1, val ? 1 : 0); out.write_shift(1, 0) }
    return out
  }
  ...
  function write_biff8_global (wb, bufs, opts) {
    ...
    var _wb = _WB.WBProps || {}
    var b8 = opts.biff == 8; var b5 = opts.biff == 5
  ...
  var HTML_ = (function () {
    function html_to_sheet (str, _opts) {
      ...
      var i = mtch.index; var j = mtch2 && mtch2.index || str.length
      var rows = split_regex(str.slice(i, j), /(:?<tr[^>]*>)/i, '<tr>')
      var R = -1; var C = 0; var RS = 0; var CS = 0
      ...
      for (i = 0; i < rows.length; ++i) {
        ...
        for (j = 0; j < cells.length; ++j) {
          ...
          if (opts.dense) { if (!ws[R]) ws[R] = []; ws[R][C] = o } else ws[encode_cell({ r: R, c: C })] = o
          C += CS
        }
      }
      ws['!ref'] = encode_range(range)
  ...
  function parse_dom_table (table, _opts) {
    ...
    var merges = []; var midx = 0
    var rowinfo = []
    var _R = 0; var R = 0; var _C; var C; var RS; var CS
    for (; _R < rows.length && R < sheetRows; ++_R) {
      ...
      for (_C = C = 0; _C < elts.length; ++_C) {
        ...
        if (opts.dense) { if (!ws[R]) ws[R] = []; ws[R][C] = o } else ws[encode_cell({ c: C, r: R })] = o
        if (range.e.c < C) range.e.c = C
        C += CS
      }
      ++R
  ...
  var parse_content_xml = (function () {
    ...
    return function pcx (d, _opts) {
      ...
      var state = []; var tmp
      var tag
      var NFtag = { name: '' }; var NF = ''; var pidx = 0
      var sheetag
      var rowtag
      var Sheets = {}; var SheetNames = []
      var ws = opts.dense ? ([]) : ({})
      var Rn, q
      var ctag = ({ value: '' })
      var textp = ''; var textpidx = 0; var textptag
      var textR = []
      var R = -1; var C = -1; var range = { s: { r: 1000000, c: 10000000 }, e: { r: 0, c: 0 } }
      var row_ol = 0
      var number_format_map = {}
      var merges = []; var mrange = {}; var mR = 0; var mC = 0
      var rowinfo = []; var rowpeat = 1; var colpeat = 1
      var arrayf = []
      var WB = { Names: [] }
      var atag = ({})
      var _Ref = ['', '']
      var comments = []; var comment = ({})
      var creator = ''; var creatoridx = 0
      var isstub = false; var intable = false
      var i = 0
      xlmlregex.lastIndex = 0
      ...
      while ((Rn = xlmlregex.exec(str))) {
        switch ((Rn[3] = Rn[3].replace(/_.*$/, ''))) {
          ...
          case 'covered-table-cell': // 9.1.5 <table:covered-table-cell>
            if (Rn[1] !== '/') ++C
            if (opts.sheetStubs) {
              if (opts.dense) { if (!ws[R]) ws[R] = []; ws[R][C] = { t: 'z' } } else ws[encode_cell({ r: R, c: C })] = { t: 'z' }
            }
            textp = ''; textR = []
            break /* stub */
 ...
 if (C >= arrayf[i][0].s.c && C <= arrayf[i][0].e.c) { q.F = arrayf[i][1] } }
  ...
  var write_content_ods = (function () {
    ...
    var write_ws = function (ws, wb, i) {
      ...
      var R = 0; var C = 0; var range = decode_range(ws['!ref'])
      var marr = ws['!merges'] || []; var mi = 0
      var dense = Array.isArray(ws)
      ...
      for (; R <= range.e.r; ++R) {
        ...
        for (; C <= range.e.c; ++C) {
          var skip = false; var ct = {}; var textp = ''
          for (mi = 0; mi != marr.length; ++mi) {
            if (marr[mi].s.c > C) continue
            if (marr[mi].s.r > R) continue
            if (marr[mi].e.c < C) continue
          ...
          var ref = encode_cell({ r: R, c: C }); var cell = dense ? (ws[R] || [])[C] : ws[ref]
          if (cell && cell.f) {
  ...
  function parse_xlsxcfb (cfb, _opts) {
    var opts = _opts || {}
    var f = 'Workbook'; var data = CFB.find(cfb, f)
    try {
  ...
  function read_plaintext_raw (data, o) {
    var str = ''; var bytes = firstbyte(data, o)
    switch (o.type) {
  ...
  function readSync (data, opts) {
    ...
    var d = data; var n = [0, 0, 0, 0]; var str = false
    var o = opts || {}
    _ssfopts = {}
    ...
    if (o.type == 'array' && typeof Uint8Array !== 'undefined' && data instanceof Uint8Array && typeof ArrayBuffer !== 'undefined') {
      // $FlowIgnore
      var ab = new ArrayBuffer(3); var vu = new Uint8Array(ab); vu.foo = 'bar'
      // $FlowIgnore
  ...
  function make_json_row (sheet, r, R, cols, header, hdr, dense, o) {
    var rr = encode_row(R)
    var defval = o.defval; var raw = o.raw || !o.hasOwnProperty('raw')
    var isempty = true
    var row = (header === 1) ? [] : {}
    if (header !== 1) {
  ...
  function sheet_to_json (sheet, opts) {
    ...
    var val = { t: 'n', v: 0 }; var header = 0; var offset = 1; var hdr = []; var v = 0; var vv = ''
    ...
    var cols = []
    var out = []
    var outi = 0; var counter = 0
    var dense = Array.isArray(sheet)
    var R = r.s.r; var C = 0; var CC = 0
  ...
  function make_csv_row (sheet, r, R, cols, fs, rs, FS, o) {
    var isempty = true
    var row = []; var txt = ''; var rr = encode_row(R)
    for (var C = r.s.c; C <= r.e.c; ++C) {
      if (!cols[C]) continue
  ...
  function sheet_to_csv (sheet, opts) {
    ...
    var FS = o.FS !== undefined ? o.FS : ','; var fs = FS.charCodeAt(0)
    var RS = o.RS !== undefined ? o.RS : '\n'; var rs = RS.charCodeAt(0)
  ...
  function sheet_to_formulae (sheet) {
    var y = ''; var x; var val = ''
    if (sheet == null || sheet['!ref'] == null) return []
    var r = safe_decode_range(sheet['!ref']); var rr = ''; var cols = []; var C
    var cmds = []
    var dense = Array.isArray(sheet)
